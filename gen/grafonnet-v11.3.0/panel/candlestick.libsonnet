...
+ {
  ...
  options+:
    {
      '#withCandleStyle': { 'function': { args: [{ default: 'candles', enums: ['candles', 'ohlcbars'], name: 'value', type: ['string'] }], help: 'Sets the style of the candlesticks' } },
      withCandleStyle(value='candles'): {
        options+: {
          candleStyle: value,
        },
      },
      '#withColorStrategy': { 'function': { args: [{ default: 'open-close', enums: ['open-close', 'close-close'], name: 'value', type: ['string'] }], help: 'Sets the color strategy for the candlesticks' } },
      withColorStrategy(value='open-close'): {
        options+: {
          colorStrategy: value,
        },
      },
      '#withColors': { 'function': { args: [{ default: { down: 'red', flat: 'gray', up: 'green' }, enums: null, name: 'value', type: ['object'] }], help: 'Set which colors are used when the price movement is up or down' } },
      withColors(value={ down: 'red', flat: 'gray', up: 'green' }): {
        options+: {
          colors: value,
        },
      },
      '#withColorsMixin': { 'function': { args: [{ default: { down: 'red', flat: 'gray', up: 'green' }, enums: null, name: 'value', type: ['object'] }], help: 'Set which colors are used when the price movement is up or down' } },
      ...
      '#withFields': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Map fields to appropriate dimension' } },
      withFields(value): {
        options+: {
          fields: value,
        },
      },
      '#withFieldsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Map fields to appropriate dimension' } },
      ...
      '#withMode': { 'function': { args: [{ default: 'candles+volume', enums: ['candles+volume', 'candles', 'volume'], name: 'value', type: ['string'] }], help: 'Sets which dimensions are used for the visualization' } },
      withMode(value='candles+volume'): {
        options+: {
          mode: value,
        },
      },
