// This file is generated, do not manually edit.
{
  ...
  '#withExemplar': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: 'Execute an additional query to identify interesting raw samples relevant for the given expr' } },
  ...
  '#withInstant': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: 'Returns only the latest value that Prometheus has scraped for the requested time series' } },
  ...
  '#withRange': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: 'Returns a Range vector, comprised of a set of time series containing a range of data points over time for each time series' } },
