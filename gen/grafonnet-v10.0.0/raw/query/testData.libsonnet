// This file is generated, do not manually edit.
{
  ...
  '#withLabels': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: '' } },
  withLabels(value): { labels: value },
  '#withLevelColumn': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: '' } },
  ...
  sim+:
    {
      ...
      '#withLast': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      withLast(value=true): { sim+: { last: value } },
      '#withStream': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: '' } },
