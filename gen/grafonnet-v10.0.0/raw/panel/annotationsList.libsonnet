  ...
  options+:
    {
      ...
      '#withOnlyFromThisDashboard': { 'function': { args: [{ default: false, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      withOnlyFromThisDashboard(value=false): { options+: { onlyFromThisDashboard: value } },
      '#withOnlyInTimeRange': { 'function': { args: [{ default: false, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      withOnlyInTimeRange(value=false): { options+: { onlyInTimeRange: value } },
