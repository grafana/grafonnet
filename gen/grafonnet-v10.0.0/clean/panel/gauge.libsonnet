  ...
  options+:
    {
      ...
      '#withShowThresholdLabels': { 'function': { args: [{ default: false, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      withShowThresholdLabels(value=false): { options+: { showThresholdLabels: value } },
