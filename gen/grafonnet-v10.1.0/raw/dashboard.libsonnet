// This file is generated, do not manually edit.
{
      ...
      list+:
        {
          ...
          current+:
            {
              ...
              '#withText': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Text to be displayed for the option' } },
              withText(value): { current+: { text: value } },
              '#withTextMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Text to be displayed for the option' } },
              withTextMixin(value): { current+: { text+: value } },
              '#withValue': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Value of the option' } },
              withValue(value): { current+: { value: value } },
              '#withValueMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Value of the option' } },
          ...
          '#withQuery': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Query used to fetch values for a variable' } },
          withQuery(value): { query: value },
          '#withQueryMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'string' }], help: 'Query used to fetch values for a variable' } },
  ...
  '#withTimepicker': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Configuration of the time picker shown at the top of a dashboard.' } },
  withTimepicker(value): { timepicker: value },
  '#withTimepickerMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'object' }], help: 'Configuration of the time picker shown at the top of a dashboard.' } },
