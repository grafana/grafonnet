// This file is generated, do not manually edit.
{
  ...
  azureLogAnalytics+:
    {
      '#withIntersectTime': { 'function': { args: [{ default: true, enums: null, name: 'value', type: 'boolean' }], help: 'If set to true the intersection of time ranges specified in the query and Grafana will be used. Otherwise the query time ranges will be used. Defaults to false' } },
      withIntersectTime(value=true): { azureLogAnalytics+: { intersectTime: value } },
