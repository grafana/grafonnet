  ...
  options+:
    {
      ...
      '#withFooter': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Footer options' } },
      withFooter(value): {
        options+: {
          footer: value,
        },
      },
      '#withFooterMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Footer options' } },
