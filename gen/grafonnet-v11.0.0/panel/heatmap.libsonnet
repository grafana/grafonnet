  ...
  options+:
    {
      ...
      '#withColor': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Controls various color options' } },
      withColor(value): {
        options+: {
          color: value,
        },
      },
      '#withColorMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Controls various color options' } },
      ...
      '#withFilterValues': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Controls the value filter range' } },
      withFilterValues(value): {
        options+: {
          filterValues: value,
        },
      },
      '#withFilterValuesMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Controls the value filter range' } },
