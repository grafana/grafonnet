  ...
  options+:
    {
      ...
      '#withFields': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '' } },
      withFields(value): {
        options+: {
          fields: value,
        },
      },
      '#withFieldsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '' } },
      ...
      '#withMode': { 'function': { args: [{ default: null, enums: ['candles+volume', 'candles', 'volume'], name: 'value', type: ['string'] }], help: '' } },
      withMode(value): {
        options+: {
          mode: value,
        },
