...
* [options.root.elements](options/root/elements/index.md)
...
* [`obj options`](#obj-options)
  * [`fn withInfinitePan(value=true)`](#fn-optionswithinfinitepan)
  ...
  * [`obj root`](#obj-optionsroot)
    * [`fn withElements(value)`](#fn-optionsrootwithelements)
    * [`fn withElementsMixin(value)`](#fn-optionsrootwithelementsmixin)
    * [`fn withName(value)`](#fn-optionsrootwithname)
    * [`fn withType()`](#fn-optionsrootwithtype)
...
#### fn options.withInfinitePan

```jsonnet
options.withInfinitePan(value=true)
```
...
Enable infinite pan
#### fn options.withInlineEditing

```jsonnet
options.withInlineEditing(value=true)
```
...
#### fn options.withRootMixin

```jsonnet
options.withRootMixin(value)
```
...
The root element of canvas (frame), where all canvas elements are nested
TODO: Figure out how to define a default value for this
#### fn options.withShowAdvancedTypes

```jsonnet
options.withShowAdvancedTypes(value=true)
```
...
##### fn options.root.withElements

```jsonnet
options.root.withElements(value)
```
...
##### fn options.root.withElementsMixin

```jsonnet
options.root.withElementsMixin(value)
```
...
The list of canvas elements attached to the root element
##### fn options.root.withName

```jsonnet
options.root.withName(value)
```
