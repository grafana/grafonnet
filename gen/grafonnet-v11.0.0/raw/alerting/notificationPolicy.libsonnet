// This file is generated, do not manually edit.
{
  ...
  '#withObjectMatchers': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'ObjectMatchers is a list of matchers that can be used to filter alerts.' } },
  withObjectMatchers(value): {
    object_matchers:
      (if std.isArray(value)
       then value
       else [value]),
  },
  '#withObjectMatchersMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['array'] }], help: 'ObjectMatchers is a list of matchers that can be used to filter alerts.' } },
  withObjectMatchersMixin(value): {
    object_matchers+:
      (if std.isArray(value)
       then value
       else [value]),
