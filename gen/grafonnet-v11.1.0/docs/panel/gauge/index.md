...
* [`obj options`](#obj-options)
  * [`fn withMinVizHeight(value=75)`](#fn-optionswithminvizheight)
  * [`fn withMinVizWidth(value=75)`](#fn-optionswithminvizwidth)
...
```jsonnet
options.withMinVizHeight(value=75)
```
...
```jsonnet
options.withMinVizWidth(value=75)
```
