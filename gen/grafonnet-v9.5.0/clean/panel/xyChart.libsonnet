          ...
          labelValue+:
            {
              ...
              '#withFixed': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string', 'number'] }], help: '' } },
              withFixed(value): { labelValue+: { fixed: value } },
              '#withFixedMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string', 'number'] }], help: '' } },
