// This file is generated, do not manually edit.
{
  ...
  '#withCreated': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'Created indicates when the service account was created.' } },
  withCreated(value): {
    created: value,
  },
  ...
  '#withUpdated': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'Updated indicates when the service account was updated.' } },
  withUpdated(value): {
    updated: value,
  },
}
