// This file is generated, do not manually edit.
{
  ...
  '#withAnnotations': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'TODO docs' } },
  withAnnotations(value): { annotations: value },
  '#withAnnotationsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'TODO docs' } },
      ...
      list+:
        {
          ...
          '#withDatasourceMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Datasource to use for annotation.' } },
          ...
          '#withRawQuery': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'Query for annotation data.' } },
          withRawQuery(value): { rawQuery: value },
          '#withShowIn': { 'function': { args: [{ default: 0, enums: null, name: 'value', type: ['integer'] }], help: '' } },
          withShowIn(value=0): { showIn: value },
          '#withTarget': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'TODO docs' } },
          withTarget(value): { target: value },
          '#withTargetMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'TODO docs' } },
          ...
          '#withType': { 'function': { args: [{ default: 'dashboard', enums: null, name: 'value', type: ['string'] }], help: '' } },
      ...
      list+:
        {
          ...
          withName(value): { name: value },
          '#withQuery': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string', 'object'] }], help: 'TODO: Move this into a separated QueryVariableModel type' } },
          withQuery(value): { query: value },
          '#withQueryMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string', 'object'] }], help: 'TODO: Move this into a separated QueryVariableModel type' } },
