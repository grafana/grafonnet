  ...
  options+:
    {
      ...
      '#withAlignValue': { 'function': { args: [{ default: null, enums: ['center', 'left', 'right'], name: 'value', type: 'string' }], help: 'Controls the value alignment in the TimelineChart component' } },
