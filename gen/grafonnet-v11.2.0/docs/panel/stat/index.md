...
* [`obj options`](#obj-options)
  * [`fn withColorMode(value="value")`](#fn-optionswithcolormode)
  * [`fn withGraphMode(value="area")`](#fn-optionswithgraphmode)
  * [`fn withJustifyMode(value="auto")`](#fn-optionswithjustifymode)
  * [`fn withOrientation(value)`](#fn-optionswithorientation)
  * [`fn withPercentChangeColorMode(value="standard")`](#fn-optionswithpercentchangecolormode)
  * [`fn withReduceOptions(value)`](#fn-optionswithreduceoptions)
  * [`fn withReduceOptionsMixin(value)`](#fn-optionswithreduceoptionsmixin)
  * [`fn withShowPercentChange(value=true)`](#fn-optionswithshowpercentchange)
  ...
  * [`fn withWideLayout(value=true)`](#fn-optionswithwidelayout)
...
```jsonnet
options.withColorMode(value="value")
```
...
```jsonnet
options.withGraphMode(value="area")
```
...
TODO docs
#### fn options.withPercentChangeColorMode

```jsonnet
options.withPercentChangeColorMode(value="standard")
```
...
* **value** (`string`)
   ...
   - valid values: `"standard"`, `"inverted"`, `"same_as_value"`
...
TODO docs
#### fn options.withShowPercentChange

```jsonnet
options.withShowPercentChange(value=true)
```
...
TODO docs
#### fn options.withWideLayout

```jsonnet
options.withWideLayout(value=true)
```
