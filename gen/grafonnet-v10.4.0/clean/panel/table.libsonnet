              ...
              cellOptions+:
                {
                  ...
                  withTableDataLinksCellOptions(value): { fieldConfig+: { defaults+: { custom+: { cellOptions+: { TableDataLinksCellOptions: value } } } } },
                  ...
                  withTableDataLinksCellOptionsMixin(value): { fieldConfig+: { defaults+: { custom+: { cellOptions+: { TableDataLinksCellOptions+: value } } } } },
