  ...
  HeatmapTooltip+:
    {
      ...
      withShowColorScale(value=true): { HeatmapTooltip+: { showColorScale: value } },
  ...
  YAxisConfig+:
    {
      ...
      withAxisBorderShow(value=true): { YAxisConfig+: { axisBorderShow: value } },
