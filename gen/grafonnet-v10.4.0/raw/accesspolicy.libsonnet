// This file is generated, do not manually edit.
{
  ...
  '#withRole': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '' } },
  withRole(value): { role: value },
  '#withRoleMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '' } },
  ...
  role+:
    {
      ...
      withXname(value): { role+: { xname: value } },
    },
  ...
  rules+:
    {
      '#': { help: '', name: 'rules' },
      '#withKind': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'The kind this rule applies to (dashboards, alert, etc)' } },
      ...
      '#withVerb': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'READ, WRITE, CREATE, DELETE, ...\nshould move to k8s style verbs like: "get", "list", "watch", "create", "update", "patch", "delete"' } },
      withVerb(value): { verb: value },
    },
  ...
  withScopeMixin(value): { scope+: value },
  scope+:
    {
      '#withKind': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '' } },
      withKind(value): { scope+: { kind: value } },
      '#withName': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '' } },
      withName(value): { scope+: { name: value } },
    },
}
