// This file is generated, do not manually edit.
{
  ...
  '#withRole': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'The role we are discussing' } },
  ...
  role+:
    {
      ...
      withBuiltinRoleRef(value): { role+: { BuiltinRoleRef: value } },
      '#withBuiltinRoleRefMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '' } },
      withBuiltinRoleRefMixin(value): { role+: { BuiltinRoleRef+: value } },
      BuiltinRoleRef+:
        {
          '#withKind': { 'function': { args: [{ default: null, enums: ['BuiltinRole'], name: 'value', type: ['string'] }], help: '' } },
          withKind(value): { role+: { kind: value } },
          '#withName': { 'function': { args: [{ default: null, enums: ['viewer', 'editor', 'admin'], name: 'value', type: ['string'] }], help: '' } },
          withName(value): { role+: { name: value } },
        },
      '#withCustomRoleRef': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '' } },
      withCustomRoleRef(value): { role+: { CustomRoleRef: value } },
      '#withCustomRoleRefMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: '' } },
      withCustomRoleRefMixin(value): { role+: { CustomRoleRef+: value } },
      CustomRoleRef+:
        {
          '#withKind': { 'function': { args: [{ default: null, enums: ['Role'], name: 'value', type: ['string'] }], help: '' } },
          withKind(value): { role+: { kind: value } },
