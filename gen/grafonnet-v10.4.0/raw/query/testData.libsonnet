  ...
  nodes+:
    {
      ...
      '#withType': { 'function': { args: [{ default: null, enums: ['random', 'response_small', 'response_medium', 'random edges'], name: 'value', type: ['string'] }], help: '' } },
      withType(value): {
        nodes+: {
          type: value,
        },
  ...
  stream+:
    {
      ...
      '#withType': { 'function': { args: [{ default: null, enums: ['signal', 'logs', 'fetch', 'traces'], name: 'value', type: ['string'] }], help: '' } },
      withType(value): {
        stream+: {
          type: value,
        },
