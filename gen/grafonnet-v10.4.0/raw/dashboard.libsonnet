  ...
  snapshot+:
    {
      ...
      '#withOriginalUrl': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: 'original url, url of the dashboard that was snapshotted' } },
      withOriginalUrl(value): { snapshot+: { originalUrl: value } },
      ...
      list+:
        {
          ...
          withAllValue(value): { allValue: value },
          ...
          withIncludeAll(value=true): { includeAll: value },
          ...
          '#withType': { 'function': { args: [{ default: null, enums: ['query', 'adhoc', 'groupby', 'constant', 'datasource', 'interval', 'textbox', 'custom', 'system'], name: 'value', type: ['string'] }], help: 'Dashboard variable type\n`query`: Query-generated list of values such as metric names, server names, sensor IDs, data centers, and so on.\n`adhoc`: Key/value filters that are automatically added to all metric queries for a data source (Prometheus, Loki, InfluxDB, and Elasticsearch only).\n`constant`: \tDefine a hidden constant.\n`datasource`: Quickly change the data source for an entire dashboard.\n`interval`: Interval variables represent time spans.\n`textbox`: Display a free text input field with an optional default value.\n`custom`: Define the variable options manually using a comma-separated list.\n`system`: Variables defined by Grafana. See: https://grafana.com/docs/grafana/latest/dashboards/variables/add-template-variables/#global-variables' } },
          withType(value): { type: value },
        },
    },
  ...
  timepicker+:
    {
      ...
      withNowDelay(value): { timepicker+: { nowDelay: value } },
