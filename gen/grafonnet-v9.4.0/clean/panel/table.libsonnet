...
+ {
      ...
      custom+:
        {
          ...
          '#withCellOptions': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object', 'object', 'object', 'object', 'object', 'object', 'object'] }], help: 'Table cell options. Each cell has a display mode and other potential options for that display.' } },
          ...
          '#withCellOptionsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object', 'object', 'object', 'object', 'object', 'object', 'object'] }], help: 'Table cell options. Each cell has a display mode and other potential options for that display.' } },
  ...
  options+:
    {
      '#withCellHeight': { 'function': { args: [{ default: null, enums: ['sm', 'md', 'lg'], name: 'value', type: ['string'] }], help: 'Height of a table cell' } },
