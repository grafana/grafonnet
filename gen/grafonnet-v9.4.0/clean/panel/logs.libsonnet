  ...
  options+:
    {
      ...
      '#withEnableLogDetails': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      withEnableLogDetails(value=true): { options+: { enableLogDetails: value } },
      '#withPrettifyLogMessage': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      withPrettifyLogMessage(value=true): { options+: { prettifyLogMessage: value } },
      '#withShowCommonLabels': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      withShowCommonLabels(value=true): { options+: { showCommonLabels: value } },
      '#withShowLabels': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      withShowLabels(value=true): { options+: { showLabels: value } },
      '#withShowTime': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      ...
      '#withWrapLogMessage': { 'function': { args: [{ default: null, enums: null, name: 'value', type: 'boolean' }], help: '' } },
