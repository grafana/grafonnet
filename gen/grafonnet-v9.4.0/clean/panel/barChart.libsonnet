  ...
  options+:
    {
      ...
      '#withFullHighlight': { 'function': { args: [{ default: false, enums: null, name: 'value', type: 'boolean' }], help: 'Enables mode which highlights the entire bar area and shows tooltip when cursor\nhovers over highlighted area' } },
      withFullHighlight(value=false): { options+: { fullHighlight: value } },
      ...
      '#withStacking': { 'function': { args: [{ default: null, enums: ['none', 'normal', 'percent'], name: 'value', type: 'string' }], help: 'TODO docs' } },
