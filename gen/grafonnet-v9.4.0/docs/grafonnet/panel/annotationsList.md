...
* [fieldOverride](annotationsList/fieldOverride.md)
* [link](annotationsList/link.md)
* [thresholdStep](annotationsList/thresholdStep.md)
* [transformation](annotationsList/transformation.md)
* [valueMapping](annotationsList/valueMapping.md)
...
```ts
withNavigateToPanel(value=true)
```
