  ...
  CodeOptions+:
    {
      ...
      '#withShowLineNumbers': { 'function': { args: [{ default: false, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      withShowLineNumbers(value=false): { CodeOptions+: { showLineNumbers: value } },
      '#withShowMiniMap': { 'function': { args: [{ default: false, enums: null, name: 'value', type: 'boolean' }], help: '' } },
      ...
      code+:
        {
          ...
          '#withShowLineNumbers': { 'function': { args: [{ default: false, enums: null, name: 'value', type: 'boolean' }], help: '' } },
          withShowLineNumbers(value=false): { options+: { code+: { showLineNumbers: value } } },
          '#withShowMiniMap': { 'function': { args: [{ default: false, enums: null, name: 'value', type: 'boolean' }], help: '' } },
          withShowMiniMap(value=false): { options+: { code+: { showMiniMap: value } } },
        },
