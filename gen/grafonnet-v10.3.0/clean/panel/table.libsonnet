      ...
      defaults+:
        {
          custom+:
            {
              '#withAlign': { 'function': { args: [{ default: null, enums: ['auto', 'left', 'right', 'center'], name: 'value', type: ['string'] }], help: 'TODO -- should not be table specific!\nTODO docs' } },
              withAlign(value): { fieldConfig+: { defaults+: { custom+: { align: value } } } },
              '#withCellOptions': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Table cell options. Each cell has a display mode\nand other potential options for that display.' } },
              withCellOptions(value): { fieldConfig+: { defaults+: { custom+: { cellOptions: value } } } },
              '#withCellOptionsMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Table cell options. Each cell has a display mode\nand other potential options for that display.' } },
                  ...
                  TableAutoCellOptions+:
                    {
                      ...
                      withType(value): { fieldConfig+: { defaults+: { custom+: { cellOptions+: { type: value } } } } },
                    },
                  ...
                  TableSparklineCellOptions+:
                    {
                      ...
                      withSpanNullsMixin(value): { fieldConfig+: { defaults+: { custom+: { cellOptions+: { spanNulls+: value } } } } },
                      ...
                      withAxisBorderShow(value=true): { fieldConfig+: { defaults+: { custom+: { cellOptions+: { axisBorderShow: value } } } } },
                      ...
                      withHideValue(value=true): { fieldConfig+: { defaults+: { custom+: { cellOptions+: { hideValue: value } } } } },
                      '#withType': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['string'] }], help: '' } },
                      withType(value): { fieldConfig+: { defaults+: { custom+: { cellOptions+: { type: value } } } } },
                    },
              ...
              '#withDisplayMode': { 'function': { args: [{ default: null, enums: ['auto', 'color-text', 'color-background', 'color-background-solid', 'gradient-gauge', 'lcd-gauge', 'json-view', 'basic', 'image', 'gauge', 'sparkline', 'custom'], name: 'value', type: ['string'] }], help: "Internally, this is the \"type\" of cell that's being displayed\nin the table such as colored text, JSON, gauge, etc.\nThe color-background-solid, gradient-gauge, and lcd-gauge\nmodes are deprecated in favor of new cell subOptions" } },
