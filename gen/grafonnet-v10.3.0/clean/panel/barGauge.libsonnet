  ...
  options+:
    {
      ...
      withMaxVizHeight(value=300): { options+: { maxVizHeight: value } },
      '#withMinVizHeight': { 'function': { args: [{ default: 16, enums: null, name: 'value', type: ['integer'] }], help: '' } },
      withMinVizHeight(value=16): { options+: { minVizHeight: value } },
      '#withMinVizWidth': { 'function': { args: [{ default: 8, enums: null, name: 'value', type: ['integer'] }], help: '' } },
      withMinVizWidth(value=8): { options+: { minVizWidth: value } },
      '#withNamePlacement': { 'function': { args: [{ default: null, enums: ['auto', 'top', 'left'], name: 'value', type: ['string'] }], help: 'Allows for the bar gauge name to be placed explicitly' } },
      withNamePlacement(value): { options+: { namePlacement: value } },
      ...
      '#withSizing': { 'function': { args: [{ default: null, enums: ['auto', 'manual'], name: 'value', type: ['string'] }], help: 'Allows for the bar gauge size to be set explicitly' } },
      withSizing(value): { options+: { sizing: value } },
