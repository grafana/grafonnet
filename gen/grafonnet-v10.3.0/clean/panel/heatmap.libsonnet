  ...
  options+:
    {
      ...
      withTooltip(value={ mode: 'single', showColorScale: false, yHistogram: false }): { options+: { tooltip: value } },
      ...
      tooltip+:
        {
          ...
          withHeatmapTooltip(value): { options+: { tooltip+: { HeatmapTooltip: value } } },
          '#withHeatmapTooltipMixin': { 'function': { args: [{ default: null, enums: null, name: 'value', type: ['object'] }], help: 'Controls tooltip options' } },
          withHeatmapTooltipMixin(value): { options+: { tooltip+: { HeatmapTooltip+: value } } },
          HeatmapTooltip+:
            {
              ...
              withShowColorScale(value=true): { options+: { tooltip+: { showColorScale: value } } },
      ...
      yAxis+:
        {
          ...
          withAxisBorderShow(value=true): { options+: { yAxis+: { axisBorderShow: value } } },
