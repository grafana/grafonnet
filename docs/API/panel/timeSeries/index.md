...
* [`obj options`](#obj-options)
  ...
  * [`obj timezone`](#obj-optionstimezone)
    * [`fn withTimeZoneBrowser()`](#fn-optionstimezonewithtimezonebrowser)
    * [`fn withTimeZoneUtc()`](#fn-optionstimezonewithtimezoneutc)
...
#### obj options.timezone


##### fn options.timezone.withTimeZoneBrowser

```jsonnet
options.timezone.withTimeZoneBrowser()
```


Use the timezone defined by end user web browser
##### fn options.timezone.withTimeZoneUtc

```jsonnet
options.timezone.withTimeZoneUtc()
```
